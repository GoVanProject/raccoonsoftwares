...
export function MagicCard(props: MagicCardProps) {
  ...
  const glowFrom = isOrbMode(props) ? (props.glowFrom ?? "#3278FF") : "#3278FF";
  const glowTo = isOrbMode(props) ? (props.glowTo ?? "#7C5CFF") : "#7C5CFF";
  ...
  const borderBackground = useMotionTemplate`linear-gradient(hsl(var(--background)) 0 0) padding-box, radial-gradient(${gradientSize}px circle at ${mouseX}px ${mouseY}px, ${gradientFrom}, ${gradientTo}, hsl(var(--border)) 100%) border-box`;
