...
export default function ProfilePage() {
  ...
  async function saveProfile(event: FormEvent<HTMLFormElement>) {
    ...
    setSaving(true);
    try {
      const response = await taskboardFetch<{ user: User }>(
        "/api/auth/me",
        token,
        {
          method: "PATCH",
    ...
    <main className="workspace-page">
      <section className="profile-shell">
        <header className="profile-heading">
          <div>
            <Link className="profile-back-link" href="/workspace">
        ...
        {loading ? (
          <div
            className="profile-card profile-loading"
            aria-busy="true"
            aria-label="Carregando perfil"
          >
            <div className="profile-skeleton profile-skeleton-avatar" />
            <div className="profile-skeleton profile-skeleton-line" />
            <div className="profile-skeleton profile-skeleton-line profile-skeleton-short" />
          </div>
        ) : (
          <form className="profile-card profile-form" onSubmit={saveProfile}>
            <section className="profile-section">
              <div className="profile-section-heading">
                <span className="workspace-kicker">Identidade</span>
                <h2>Como sua equipe encontra você</h2>
                <p>
                  Esses dados aparecem na equipe, nas tarefas e na sala ao vivo.
                </p>
              </div>
                ...
                <div className="profile-avatar-actions">
                  ...
                  {avatarData ? (
                    <div className="profile-avatar-controls">
                      <span>{avatarName || "Foto atual"}</span>
            ...
            <section className="profile-section profile-password-section">
              <div className="profile-section-heading">
                <span className="workspace-kicker">Segurança</span>
                <h2>Troque sua senha quando quiser</h2>
                <p>Deixe os campos vazios para manter a senha atual.</p>
              </div>
              <div className="profile-fields">
                <label>
                  Nova senha
            ...
            <div className="profile-form-actions">
              <Link className="profile-cancel" href="/workspace">
                Voltar aos projetos
              </Link>
